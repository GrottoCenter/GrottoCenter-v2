...
/*
	...
	Description: UI for Proj4.js library
		-----------------------------------------------------------
		|	/!\ Warning: needs JQuery 1.4.2 and Proj4.js libraries!	|
		-----------------------------------------------------------
  License: CC by-nc as per http://creativecommons.org/licenses/by-nc/3.0/deed.en
	...
	2				|	2010-09-07	|	clem.rz -at- gmail.com	|	Creation of Proj4js.Proj object on selection only, this reduce memory usage
...
*		[opt] callback					//Callback function when transformation is done, the WGS84 object {x, y} is passed to this function
