...
да ни помогнете за завършването на  тази база данни. Можете да получите достъп до създаване / промяната менюто с панела вляво след като сте влезли в профила си<br />
...
както и цялата информация, представена в подробните описания, включително прикачени файлове (карти, снимки ...).</p>
  ...
  <div id="sensitive" style="display:none;visibility:hidden;" class="content" >
    ...
    <ul><li>Пещерата е лесно достъпна и вие искате <b>да я предпазите от</b> не желан достъп.<br />
...
В този случай, изберете опцията "Регистрирай (защитена пещера и/или Регулиран достъп)", и препоръчваме 
<b>промяна на координатите</b> на пещерата в радиус от 1 км от реалната позиция <b>При оказване</b>
на информацията в детайли да не се оказва точно разположение за достъп и подхода към входа на пещерата.<br />
